...
from .endpoints import (NicepayInitReplenishApiView,
                        NicePayTransactionCallbackApiView,
                        TransactionValidationApiView,
                        SkinifyTransactionCallbackApiView,
                        SkinifyInitReplenishApiView)

urlpatterns = [
    path("create/", NicepayInitReplenishApiView.as_view(), name="init"),
    path("create-skinify/", SkinifyInitReplenishApiView.as_view(), name="init"),
