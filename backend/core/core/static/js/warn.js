function makeWarn(header, desc) {
    document.getElementById('prize-wrappper').innerHTML = `
        <div style="display: grid;grid-template-rows: 1fr;grid-template-columns: 1fr;justify-items: center;align-items: center;transform: scale(0);transition: all .2s ease;" id="warn-content">
