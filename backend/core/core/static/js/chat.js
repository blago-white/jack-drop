...
async function renderMessages() {
    ...
    const response = await sendRequest("http://localhost/chat/api/v1/messages/", {method: "GET"});
...
async function sendChatMessage() {
    ...
    const response = await sendRequest("http://localhost/chat/api/v1/messages/create/", {
        method: "POST",
        headers: headers,
        body: JSON.stringify({
